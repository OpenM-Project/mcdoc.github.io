...
| ------ | ------ | ------ | ------ | ------
| ⭐ modscraft.net | [Website](https://modscraft.net/mcpe/) | \- | **Yes** | Unlocked APKs of Minecraft for Android available in ARM-V7A, ARM64-V8A, x86, and Clone versions, both for Preview and Release versions, maintained by.
