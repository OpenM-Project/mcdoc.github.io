...
| ------ | ------ | ------ | ------ | ------
| ⭐ ModsCraft | [Website](https://modscraft.net/en/mcpe/) or instead [Parser](https://waveye-project.github.io/modscraft_mcpe_apk) | \- | **Yes** | Unlocked APKs of Minecraft for Android available in ARM-V7A, ARM64-V8A, x86, and Clone versions, both for Preview and Release versions
