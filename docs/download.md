...
const crackedLink = ref('https://github.com/OpenM-Project/m-centers-archive/releases/latest/');
...
const selectPlatform = (platform) => {
  switch (platform) {
    case 'Windows':
      ...
      crackedLink.value = 'https://github.com/OpenM-Project/m-centers-archive/releases/latest/';
      break;
    case 'Android':
