...
const openm = [
  ...
  },
  {
    ...
    desc: 'Owner of the mcdoc.site domain, and the akshnav.netlify.app website',
    links: [
...
const mention = [
  {
    ...
    name: 'MaxRM',
    desc: 'The owner of MDLC (working on cracked appx for Minecraft), and helped in giving hex codes for BEAMinject',
    links: [
  ...
  },
  {
    ...
    desc: 'Developer of ClickGo, ClickGoLTS, DynoLTS and BlueSky Launcher.',
    links: [
...
#### *And other contributors or developers of OpenM, and its projects M Community / M Community Development, and other similar communities*
